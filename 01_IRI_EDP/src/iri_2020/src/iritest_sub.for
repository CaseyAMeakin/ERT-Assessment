...
c Setup user input of IRI input parameters
c
...
c       read(5,*) piktab
cc       print *,'lower and upper height [km] for TEC integration',
c    &          ' (valid range: 65-30,000 km) (0,0 for no TEC)'
c       read(5,*) htec_min,htec_max
cc       print *,'Options: t(rue) or f(alse)'
...
c
        open(7, file='iri_c.log') ! give output file a name
...
c  WRITE TABLE CONTENTS

        num_steps = numstp   ! for c driver
